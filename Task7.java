...
public class Task7 extends Configured implements Tool {
                ...
                if(node.getNodeType() == Node.ELEMENT_NODE){
                    ...
                    for(int x = 0; x < nrOfTags; x++) {
                        ...
                        if (tag.getNodeType() == Node.ELEMENT_NODE) {
                            ...
                            // TODO:: change to bump
                            if(tagElem.getAttribute("k").equals("traffic_calming") && tagElem.getAttribute("v").equals("bump")){
    ...
    public int run(String[] args) throws Exception {
        ...
        Job job = Job.getInstance(getConf(), "Get node id's and way id's of highways that refer to traffic_calming bump");
